...
req.on('end', () => {
      const parsedBody = Buffer.concat(body).toString(); // Concatenate the chunks and convert to string
      console.log(parsedBody); // Log the parsed body
      // Here you can process the parsedBody as needed, e.g., save to a file or database
});


   fs.writeFileSync
   ('user.txt', 'Rajendra Chaudhary');
